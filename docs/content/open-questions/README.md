...
|---|---|---|
| [06](#/open-questions/06-gate-1-intent) | Is gate 1 (the channel-0x2E kick-detector overwrite that silences the beetle wing-flip) intentional or an authorial accident? | [#0048](#/issues) |
